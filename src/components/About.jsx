...
const About = () => {
  ...
  return (
    <section
      ref={sectionRef}
      id="about"
      className="section-gap px-6 bg-zinc-950/50 relative overflow-hidden"
    >
      ...
      <div className="section-container relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          <div ref={textRef} className="space-y-10">
            <span className="text-label block">About Me</span>
            <h2 className="text-display-2 italic leading-[1.02]">
              Crafting <br />
              <span className="animated-gradient-text">Digital Frontiers</span>
            </h2>
            ...
            <div className="flex flex-wrap gap-4 pt-6 border-t border-white/10">
              <a href="https://github.com/LenovoBeast" className="flex items-center gap-2 px-5 py-2.5 glass hover:bg-white/5 rounded-xl text-sm font-medium transition-colors active-press" target="_blank" rel="noopener noreferrer">
                <Github size={18} /> GitHub
              </a>
              <a href="https://twitter.com/LenovoBeast" className="flex items-center gap-2 px-5 py-2.5 glass hover:bg-white/5 rounded-xl text-sm font-medium transition-colors active-press" target="_blank" rel="noopener noreferrer">
                <Twitter size={18} /> Twitter
              </a>
              <a href="https://linkedin.com/in/lenovobeast" className="flex items-center gap-2 px-5 py-2.5 glass hover:bg-white/5 rounded-xl text-sm font-medium transition-colors active-press" target="_blank" rel="noopener noreferrer">
                <Linkedin size={18} /> LinkedIn
              </a>
              <a href="mailto:lenovobeast@example.com" className="flex items-center gap-2 px-5 py-2.5 glass hover:bg-white/5 rounded-xl text-sm font-medium transition-colors active-press">
                <Mail size={18} /> Email
              </a>
            </div>
          </div>
          ...
          <div className="space-y-8">
            <div ref={imageRef} className="relative">
              <div className="double-bezel p-1.5 aspect-square hover-lift">
                <div className="aspect-square rounded-[calc(1.5rem-0.375rem)] bg-gradient-to-br from-purple-600/10 to-cyan-600/10 flex items-center justify-center relative overflow-hidden">
                  ...
                  <Terminal size={64} className="text-purple-400/30 relative z-10" />
                </div>
              </div>
            ...
            <div ref={statsRef} className="grid grid-cols-2 gap-4 pt-6 border-t border-white/10">
              {stats.map((stat, i) => (
                <div key={i} className="p-4 glass rounded-2xl hover-lift hover:border-white/10 transition-colors active-press">
        ...
        <div className="mt-20">
          <h3 className="text-label mb-8">Timeline</h3>
          <div className="relative">
            <div className="absolute left-8 top-0 bottom-0 w-px bg-gradient-to-b from-purple-500/30 via-transparent to-cyan-500/30" />
            <div ref={timelineRef} className="space-y-12">
              {timeline.map((item, i) => (
                <div key={i} className="relative pl-20 group">
                  <div className="absolute left-0 top-1 w-16 h-16 rounded-2xl bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center shadow-lg shadow-purple-500/30 group-hover:scale-110 transition-transform duration-500 z-10">
                    <span className="text-sm font-black">{item.year}</span>
                  </div>
                  <div className="glass p-6 rounded-2xl hover:border-white/10 transition-colors active-press">
